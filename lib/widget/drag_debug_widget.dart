...
class DragDebugWidget extends StatefulWidget {
  static _MyController myController = new _MyController();

  final OverlayEntry overlayEntry;

  DragDebugWidget({this.overlayEntry});

  @override
  _DragDebugWidgetState createState() => _DragDebugWidgetState();
}

class _DragDebugWidgetState extends State<DragDebugWidget> {
  static final String sName = "_DragDebugWidgetState";

  Offset _offset = Offset(
      ScreenUtil.getInstance().screenWidth > 100
          ? ScreenUtil.getInstance().screenWidth - 50
    ...
    return Positioned(
      ...
      child: GestureDetector(
        onPanUpdate: (DragUpdateDetails details) {
          ...
          DragDebugWidget.myController.play('fail');
        },
        onTap: () {
          DragDebugWidget.myController.play("success");
...
class _MyController extends FlareControls {
  //用于获取ctrl_eyes节点
  ...
  _MyController({this.projectGaze = 100});
